...
export default function StudentQuizTestV2() {
 ...
 {/* const handleSubmit = async () => {
      ...
      for (const quiz of quizzes) {
        ...
        if (questionType === 'multiple_choice') {
          await api.submitAnswer({
            quiz_id: quiz.id,
            student_id: studentName.trim() || 'anonymous',
          ...
          await api.submitAnswer({
            ...
            student_id: studentName.trim() || 'anonymous',
            selected_index: null,
            short_answer: typeof answer === 'string' ? answer : '',
          });
        }
      }
  ...
  const handleSubmit = async () => {
  // Lọc các câu chưa trả lời (bỏ qua suggestion)
  ...
  // Nếu có câu chưa trả lời, hiển thị danh sách số câu
