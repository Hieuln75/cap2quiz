          ...
          {loading ? (
            ...
            quizDetails.map((qa, index) => {
              ...
              return (
                ...
                >
                  <p style={{ fontWeight: 'bold' }}>Câu {index + 1}: {qa.quiz.question}</p>
                  ...
                  {qa.quiz.question_type === 'short_answer' && (
                    <>
      ...
      <ul style={{ paddingLeft: 0, listStyle: 'none' }}>
        ...
        {submissions.map((submission) => (
          <li key={submission.id} style={{ marginBottom: 12 }}>
            ...
            >
              🧑 Bài làm ID: {submission.id} | 🕒 {new Date(submission.created_at).toLocaleString()}
            </button>
          </li>
        ))}
      </ul>
